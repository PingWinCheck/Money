...
class Messanger(Base):
    ...
    sender: Mapped["User"] = relationship(foreign_keys=[sender_id], back_populates='users.sender')
    recipient: Mapped['User'] = relationship(foreign_keys=[recipient_id], back_populates='users.recipient')
